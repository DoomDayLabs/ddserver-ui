...
exports.request = exports.host = undefined;
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    { style: { display: 'flex', justifyContent: 'space-between' } },
                    _react2.default.createElement(_reactToolbox.Input, { label: 'ValueChar', value: this.state.valueChar, onChange: function onChange(valueChar) {
                            return _this2.setState({ valueChar: valueChar });
                        } })
                )
            );
        }
    ...
    _createClass(Step2, [{
        ...
        value: function handleNext() {
            ...
            this.props.config.config.sensors = this.state.selected.map(function (s) {
                return {
                    title: s.name,
                    sensor: _this2.props.device.id + '.' + s.name
                };
            });
